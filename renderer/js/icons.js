...
export const ICONS = {
  ...
  list: S(`
    ...
    <circle cx="4" cy="6" r=".9" fill="currentColor" stroke="none"/>
    <circle cx="4" cy="12" r=".9" fill="currentColor" stroke="none"/>
    <circle cx="4" cy="18" r=".9" fill="currentColor" stroke="none"/>`),
